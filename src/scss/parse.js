 ...
 */
function checkS(i) {
  return i < tokensLength && tokens[i].whiteSpace ? tokens[i].whiteSpace_last - i + 1 : 0;
}
...
function getS() {
  let startPos = pos;
  let x = joinValues(pos, tokens[pos].whiteSpace_last);

  pos = tokens[pos].whiteSpace_last + 1;
